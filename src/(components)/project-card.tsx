      ...
      >
        ...
        <div className="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-800">
          {image ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-black/5 dark:bg-white/10 border border-black/10 dark:border-white/20 backdrop-blur-sm hover:bg-black/10 dark:hover:bg-white/20">
              ...
              {demo ? (
                ...
                <Link href={`/projects/${id}/preview`} className="flex-1">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 px-4 py-2 btn-primary rounded-lg transition-colors text-sm font-medium h-full justify-center shadow-lg shadow-purple-500/20"
                  >
